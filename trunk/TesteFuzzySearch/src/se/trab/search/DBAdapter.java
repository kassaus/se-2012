...
public class DBAdapter {
    ...
    private static final String CREATE_TAB_ITEM =
	    "CREATE TABLE item ("
    ...
    private static final String CREATE_TAB_COL =
    	    "CREATE TABLE col ("
    	    	+ "_id INTEGER PRIMARY KEY AUTOINCREMENT, "
    	    	+ "nomeCol VARCHAR(255), "
    	    	+ "local VARCHAR(255) "
    ...
    public long insertItem(String tipo,String titulo, String autor, String editor,
    						String ano_pub,String edicao, String qrcode, String barcode,
    						String ext_tipo,String obs_pess) 
    {
    	
        ContentValues linha = new ContentValues();
    	linha.put("tipo", tipo);
        linha.put("titulo", titulo);
        linha.put("autor", autor);
        linha.put("editor", editor);
        linha.put("ano_pub", ano_pub);
        linha.put("edicao", edicao);
        linha.put("qrcode", qrcode);
        linha.put("barcode", barcode);
        linha.put("ext_tipo", ext_tipo);
        linha.put("obs_pess", obs_pess);
        linha.put("id_coll", 0);
