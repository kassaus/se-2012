...
//		bd.deleteAllItems();
	...
	private void mostraCaptura2(String contents, String format) {
		...
		if (jo != null) {
			...
			item = new Item();
			tipo.setText("Não encontrado");
			titulo.setText("Não encontrado");
			autor.setText("Não encontrado");
			anoPub.setText("Não encontrado");
			edicao.setText("Não encontrado");
			editor.setText("Não encontrado");
		}
